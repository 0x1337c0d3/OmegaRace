...
TriShip::TriShip()
    : m_ThreatLevel(0.0f), m_PulseIntensity(0.0f), m_AnimationTime(0.0f), m_AggressiveMode(false),
      m_Mode(TriShipMode::ENEMY), m_MineWarningIntensity(0.0f), m_VapourTrail(25), // Standard trail length
...
void TriShip::drawMenacingEffects() {
    ...
    for (int point = 0; point < 3; point++) {
        ...
        Vector2i center = Vector2i((newTriangle[0].start.x + newTriangle[1].start.x + newTriangle[2].start.x) / 3,
