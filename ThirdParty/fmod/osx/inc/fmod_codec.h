...
/*
    Codec functions
*/
typedef FMOD_RESULT(F_CALLBACK* FMOD_CODEC_METADATA_FUNC)(FMOD_CODEC_STATE* codec_state, FMOD_TAGTYPE tagtype,
...
typedef void(F_CALLBACK* FMOD_CODEC_LOG_FUNC)(FMOD_DEBUG_FLAGS level, const char* file, int line, const char* function,
                                              const char* string, ...);

typedef FMOD_RESULT(F_CALLBACK* FMOD_CODEC_FILE_READ_FUNC)(FMOD_CODEC_STATE* codec_state, void* buffer,
                                                           unsigned int sizebytes, unsigned int* bytesread);
typedef FMOD_RESULT(F_CALLBACK* FMOD_CODEC_FILE_SEEK_FUNC)(FMOD_CODEC_STATE* codec_state, unsigned int pos,
...
#define FMOD_CODEC_ALLOC(_state, _size, _align) (_state)->functions->alloc(_size, _align, __FILE__, __LINE__)
